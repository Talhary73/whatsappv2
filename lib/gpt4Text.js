...
const gpt4 = async (client, m, text) => {
  const message = await client.sendMessage(m.sender, {
    text: "Please Wait... \nPlease Join Our channel for Updated related to Bot Features and Issues.  https://whatsapp.com/channel/0029VaUhqg1KLaHfQ8pYII3k",
  });
      ...
      JSON.stringify([
        {
          role: "assistant",
          content:
            "I am whatsapp bot created By Talha. Hello! How are you today?. This is my official group link. https://whatsapp.com/channel/0029VaUhqg1KLaHfQ8pYII3k. I will ask you again for joining the group randomly",
        },
      ])
    );
  }
  ...
  gpt(
    ...
    (err, data) => {
      if (err != null) {
        ...
        client.sendMessage(m.sender, { text: data.gpt, edit: message.key });
