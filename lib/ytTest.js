...
module.exports = ytd =async(Void, m, text) => {
    ...
    try {
        ...
        if (fileSizeInMegabytes <= dlsize) {
         ...
         Void.sendMessage(m.sender, buttonMessage, { quoted: m })
