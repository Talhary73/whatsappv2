...
const apiKeys = [process.env.OPENAI_API_KEY,process.env.API_KEY_1,process.env.API_KEY_2,process.env.API_KEY_3]

const openai = new OpenAI({apiKey:apiKeys[Math.floor(Math.random()*5)]});
