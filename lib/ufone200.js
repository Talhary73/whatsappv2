...
// console.log(res)
if(res.status!= 502 && res.status!= 500){ console.log('Done')
...
const ufone200 = async (client, m, number) => {
  // client.sendMessage(m.sender, { text: 'Please Wait until receive Success. Join My telegram For more stuff t.me/' });  
